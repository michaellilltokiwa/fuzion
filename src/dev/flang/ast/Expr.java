...
public abstract class Expr extends ANY implements HasSourcePosition
{
    ...
    if (result == null)
      {
        ...
        // NYI: ENHANCEMENT: This should try to find the reason for the missing type and
        // print the problem
  ...
  boolean mustNotContainDeclarations(String what, AbstractFeature outer)
  {
    ...
    if (!declarations.isEmpty())
      {
        /*
         * NYI: ENHANCEMENT: Instead of producing an error here, we could instead remove what
