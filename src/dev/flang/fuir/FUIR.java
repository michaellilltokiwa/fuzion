...
public abstract class FUIR extends IR
{
   ...
   * @param cl a clazz id
   *
   * @return id of cl's result field or NO_CLAZZ if cl has no result field (NYI: UNDER DEVELOPMENT:
   ...
   *
   * NYI: PERFORMANCE: Performance: This requires time {@code O(codeSize(c))}, so using this
   ...
   * expression. Say you have the code  -- NYI: DOCUMENTATION: This example is confusing and probably wrong --
   *
   *   0: const 1
   *   1: current
   *   2: call field 'n'
