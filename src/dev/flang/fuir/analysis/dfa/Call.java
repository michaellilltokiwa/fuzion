...
public class Call extends ANY implements Comparable<Call>, Context
{
   ...
   *
   * NYI: ENHANCEMENT: This currently modifies the effect and hence the call. We should check
    ...
    if ((_env == null || !_env.hasEffect(ecl)) && _dfa._defaultEffects.get(ecl) == null)
      {
        if (_dfa._reportResults && DFA.TRACE_ENVS)
          {
            // NYI: ENHANCEMENT: Make this a normal error similar to DfaErrors.usedEffectnotinstalled:
